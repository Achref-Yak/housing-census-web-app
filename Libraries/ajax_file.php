...
class Ajax_file {
    ...
    function __construct($options=null) {
        $this->options = array(
            ...
            'image_versions' => array(
                 ...
                 */
                'thumbnail' => array(
                    'upload_dir' => dirname(__FILE__) . '/../../upload/thumbnails/',
                    'upload_url' => dirname($_SERVER['PHP_SELF']) . '/../../upload/thumbnails/',
                    'max_width' => 80,
                    'max_height' => 80
                )
            )
     ...
     * 
     */
    public function rewrite($fichier){
...
//dans $fichier par un tiret "-" et qui place le résultat dans $fichier.
    ...
    private function handle_file_upload($uploaded_file, $name, $size, $type, $error) {
        $file = new stdClass();
        $file->name = time()."_".$this->rewrite(basename(stripslashes($name)));
