...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_datetime_input($field_info,$value)
	{
		...
		({$this->ui_date_format}) hh:mm:ss";*/
              $input = "<input name='{$field_info->name}' type='text' value='$datetime' maxlength='19' class='datetime-input w_90' /> 
		<a class='datetime-input-clear' tabindex='-1'>";  
		return $input;
	}
	...
	protected function get_upload_file_input($field_info, $value)
	{
		...
		$input .= "		<a href='".base_url().$field_info->extras->upload_path.'/'.$value."' class='open-file' target='_blank' id='file_$unique'><img src='".base_url().$field_info->extras->upload_path.'/'.$value."' class='resise_img'></a> ";
...
class grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_javascript_path				= 'assets/plugins/grocery_crud/js';
	protected $default_css_path						= 'assets/plugins/grocery_crud/css';
	protected $default_texteditor_path 				= 'assets/plugins/grocery_crud/texteditor';
	protected $default_theme_path					= 'assets/plugins/grocery_crud/themes';
	protected $default_language_path				= 'assets/plugins/grocery_crud/languages';
